...
const ApartSuccess = () => {
  ...
  const handleNext = () => history.push("/process-rooms-advert5");
  return (
    <div>
      <Header />
      <div>
          ...
          <div className="container">
            <div className="row justify-content-center">
              ...
              <div className="col-lg-8 text-center">
                ...
                <div>
                  <p className="my-40">
                    Your apartment/Building Advert was successfully placed and
                    should appear on the search for others to view aond contact
                    you
                  </p>
                </div>
              </div>
