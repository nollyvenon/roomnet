...
const NeedRoom2 = () => {
  ...
  const handleNext2 = async () => {
    ...
    await axios
      ...
      .then(() => {
        history.push("/process-needrooms-advert3");
      })
      .catch((err) => {
        setLoading2(false);
  ...
  const checkUserRegistered = async () => {
    await axios
      .get(`/api/v1/isUserRegistered/${NeedRoomReducer.email}`)
      .then((response) => {
        console.log(response.data);
            ...
            <div className="property-info mt-30 bg-white py-40 px-30">
              <div className="text-center">
                <h5 className="color-primary">
                  Welcome {NeedRoomReducer.email}, login to contnue
                </h5>
              </div>
