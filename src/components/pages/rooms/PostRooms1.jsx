...
const PostRooms1 = () => {
  ...
  const validatePage = async () => {
    ...
    if (!no_toilets) {
      newError.push("You did not provide the number of Toilets/bathrooms");
    }
    if (!no_occupants) {
      newError.push("You did not provide the number of occupants");
    }
    if (!Building_type) {
                  ...
                  >
                    <div className="property-info mt-30 bg-white py-40 px-30">
                      ...
                      <div className="row">
                        ...
                        <div className="form-group col-lg-6">
                          <label>Number Of Present Occupant</label>
                          <input
                            className="form-control bg-gray"
                            type="number"
                            name="land-area"
                            value={formResponse.no_occupants}
                            onChange={(e) =>
                              setFormResponse({
                                ...formResponse,
                                no_occupants: e.target.value,
                              })
                            }
                          />
                        </div>
                        ...
                        <div className="form-group col-lg-6">
                          <label>My Email (Kept Confidential)</label>
                          <input
                            className="form-control bg-gray"
                            type="text"
                            name="land-area"
