      ...
      <div className="property-list mt-30">
        <div className="property-item d-flex">
          ...
          <div className="property-content bg-white pt-30 pb-50 px-30 position-relative">
            <Link
              to={{ pathname: "/DetailView2", state: data }}
            ...
            <ul className="about-property icon-primary d-table mt-20">
              ...
              <li>
                <i className="flaticon-hotel" />3 Bedrooms
              </li>
              <li>
                <i className="flaticon-bathtub" />2 Bathrooms
              </li>
              <li>
                <i className="flaticon-garage" />1 Garage
              </li> */}
...
const SearchResult2 = () => {
  ...
  const ListApartmentsByLocation = async () => {
    // const states = "lagos";
    setLoading(true)
    await axios
      .get(
        `/api/v1/ListApartByLocation/?location=${state.location}&pageNo=${pageNo}`
      )
      .then((response) => {
        setLoading(false)
            ...
            <div className="col-md-12 col-lg-12 wow slideInDown animated">
              <div className="top-filter pb-15 border-bottom-1-gray">
                <h3 className="color-secondary line-bottom pb-15 mb-20">
                  {state.location
                    ? `Apartments/Flats within "${state.location}"`
                    : state.address
                    ? `Apartments/Flats within "${state.address}"`
                    : null}
                </h3>
                <div className="row">
